...
import com.golf.utils.cache.SafeExpiringCache.ExpirationPolicy;
import com.golf.utils.cache.SafeExpiringCache.ExpiringEntry;
...
public class ExpiringMapEntryTest {
    ...
    /**
     * Tests that replacement of entries in a set is as expected per ordering via {@link ExpiringEntry#compareTo(Entry)}
     * .
     */
    @Test
