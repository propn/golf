...
public class MultipartParser {
     ...
     * @param req the servlet request.
     * @param maxSize the maximum size of the POST content.
     * @param buffer whether to do internal buffering or let the server buffer, useful for servers that don't buffer
     * @param limitLength boolean flag to indicate if we need to filter the request's input stream to prevent trying to
